...
function PageOne(props) {
	return (
        ...
        <Center mt='30px' gap='10px'>
            <Text borderRadius='50px' w='300px' textAlign='center' padding='1px' bgColor='red.500' color='white' fontSize='40px'>7 Days of UMN life</Text>
        </Center>
        </GridItem>
        </Grid>
        <Grid className="Grid" h='10vh' templateRows='repeat(1, 1fr)' templateColumns='repeat(3, 1fr)' gap={0}>
        <GridItem className="gridItems" rowSpan={1} colSpan={3}>
        <Center mt='30px' gap='10px'>
        <Input bgColor='White' width='100%' maxW='350px' color='Black'  variant='outline' placeholder='Masukan Nama' />
        <Button>✔</Button>
        </Center>
        </GridItem>
        </Grid>
