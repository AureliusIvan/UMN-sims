      ...
      <Box>
        ...
        <Modal isOpen={isOpen} onClose={onClose} isCentered>
          ...
          <ModalContent bg="rgba(0,0,0,0)" boxShadow="none" borderRadius={30}>
            ...
            <ModalBody>
							<Flex py={5} px={10} fontSize="lg" borderRadius="0px 0px 20px 20px" mt="-10px" backgroundColor="white" flexDir="column"  justifyContent="center">
								<Text color="blue" align="left">Skill :</Text>
