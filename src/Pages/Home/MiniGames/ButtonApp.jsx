...
import {
  Box, Button, Image, Grid, GridItem, Text, VStack, HStack,
} from '@chakra-ui/react';
import './game.css';
import {AllContext} from '../../../components/Value/CoinContext';
import {
  CoinFunction, StatFunction, CheckStatFull
...
const cardImages = [{src: book, matched: false}, {src: burger, matched: false}, {
  src: cake,
  matched: false
}, {src: candy, matched: false}, {src: chips, matched: false}, {src: coin, matched: false}, {
  src: macaron,
  matched: false
...
function Onecard({card, handleChoice, flipped, disabled}) {
  ...
  return (<GridItem rowSpan={1} colSpan={1} className="card">
